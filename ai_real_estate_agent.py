...
class PropertyFindingAgent:
    ...
    def __init__(self, firecrawl_api_key: str, openai_api_key: str, model_id: str = "o3-mini"):
        self.agent = Agent(
            model=Groq(id=model_id, api_key=openai_api_key),
            markdown=True,
...
def main():
    ...
    with st.sidebar:
        ...
        model_id = st.selectbox(
            "Choose GROQ Model",
            options=["deepseek-r1-distill-llama-70b", "llama-3.1-8b-instant","llama-3.2-90b-vision-preview"],
        ...
        firecrawl_key = st.text_input(
            ...
            # value="fc-4427080d5s6ac4cddf58269d2cfdf38058a"
        )
        openai_key = st.text_input(
            "GROQ API Key",
            type="password",
            help="Enter your OpenAI API key",
            # value="gsk_rjX6DWp8e8be3E0hZMPnWddGdyb3FYBCH6kY3sDJgde3m0s2z8e7J95"
        )
    ...
    st.title("🏠 AI Real Estate Agent (By Chaitanya)")
